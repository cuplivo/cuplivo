...
///
/// When the current assistant enables the dynamic gradient, image handling is
/// skipped entirely: the gradient takes precedence and masks the persisted
/// wallpaper (the `background` value is never cleared).
  ...
  Widget build(BuildContext context) {
    ...
    if (bg.startsWith('http')) {
      ...
      try {
        ...
        debugPrint(
          'ChatAssistantBackground: failed to resolve wallpaper path: $error',
        );

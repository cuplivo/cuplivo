## 0.4.0 + Cuplivo printToPdf

* Cuplivo vendored package: adds `WebviewController.printToPdf()` backed by
  `ICoreWebView2::PrintToPdfAsync` with paper size / margins / backgrounds
  options (used by conversation PDF export; see docs/adr/0044).

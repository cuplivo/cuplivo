...
abstract class AppLocalizations {
  ...
  /// No description provided for @groupChatDirectorLogsEntryTitle.
  ///
  /// In en, this message translates to:
  /// **'Director call {index}'**
  ...
  /// No description provided for @groupChatDirectorLogsObservedSpeaker.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @statsPageFilterTitle.
  ///
  /// In en, this message translates to:
  /// **'Filters'**
  String get statsPageFilterTitle;

  /// No description provided for @statsPageDefaultAssistant.
  ///
  /// In en, this message translates to:
  /// **'Default Assistant'**

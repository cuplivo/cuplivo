...
import 'package:Cuplivo/features/home/../chat/widgets/chat_message_widget.dart'
    show ChatMessageWidget, ReasoningSegment;
import 'package:Cuplivo/features/home/../chat/widgets/message_more_sheet.dart'
    show showMessageMoreSheet, MessageMoreAction;
import 'package:Cuplivo/features/home/services/multi_ai_engine.dart'
    show MultiAIMode;
          ...
          child: ChatMessageWidget(
            ...
            onMore: () async {
              final action = await showMessageMoreSheet(
                ...
                hideActions: {MessageMoreAction.selectMessages},
              );

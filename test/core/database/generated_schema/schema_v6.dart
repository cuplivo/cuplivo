...
class GroupChatRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GroupChatRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> assistantDetailInjectionMode =
      GeneratedColumn<String>(
        ...
        defaultValue: const CustomExpression('\'endOfEveryUserMessage\''),
      );
  ...
  injectGroupMembersIntoAssistantSystemPrompt = GeneratedColumn<int>(
  ...
  @override
  GroupChatRows createAlias(String alias) {
    return GroupChatRows(attachedDatabase, alias);
  }
...
class GroupChatMemberRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  GroupChatMemberRows(this.attachedDatabase, [this._alias]);
  ...
  @override
  GroupChatMemberRows createAlias(String alias) {
    return GroupChatMemberRows(attachedDatabase, alias);
  }
...
class DatabaseAtV6 extends GeneratedDatabase {
  ...
  late final GroupChatRows groupChatRows = GroupChatRows(this);
  late final GroupChatMemberRows groupChatMemberRows = GroupChatMemberRows(
    this,
  );

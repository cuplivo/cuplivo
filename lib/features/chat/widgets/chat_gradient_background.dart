...
///
/// The palettes are deliberately fixed artwork colors, not theme tokens
/// (ADR-0063) — every literal is marked with `color-gate: ignore`.
  ...
  _GradientArtwork(this.size, this.dark, this.offset) {
    ...
    _base = Paint()
      ..shader = LinearGradient(
        ...
        colors: dark
            ? const [
                Color(0xFF1B2A45), // color-gate: ignore
                Color(0xFF15223A), // color-gate: ignore
                Color(0xFF0D1626), // color-gate: ignore
                Color(0xFF0A0F18), // color-gate: ignore
                Color(0xFF080B12), // color-gate: ignore
              ]
            : const [
                Color(0xFFAFD0F2), // color-gate: ignore
                Color(0xFFCBE0F6), // color-gate: ignore
                Color(0xFFF1F7FD), // color-gate: ignore
                Colors.white, // color-gate: ignore
                Colors.white, // color-gate: ignore
              ],
    ...
    final colors = dark
        ? const [
            Color(0xFF3E6FB0), // color-gate: ignore
            Color(0xFF2E7D74), // color-gate: ignore
            Color(0xFF4A6E96), // color-gate: ignore
            Color(0xFF7C5F9E), // color-gate: ignore
          ]
        : const [
            Color(0xFF9EC5F0), // color-gate: ignore
            Color(0xFFA8E6E0), // color-gate: ignore
            Color(0xFFB6D7F2), // color-gate: ignore
            Color(0xFFFFC8D2), // color-gate: ignore
          ];

package com.cup11.cuplivo.background
...
import com.cup11.cuplivo.MainActivity
import com.cup11.cuplivo.KelivoApplication
import com.cup11.cuplivo.R
...
class BackgroundRuntime(private val context: Context) {
    companion object {
        const val CHANNEL_ID = "cuplivo_generation_status"

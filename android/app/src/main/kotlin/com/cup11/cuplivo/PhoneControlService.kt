...
class PhoneControlService : AccessibilityService() {
    companion object {
        ...
        fun execute(json: String, complete: (String) -> Unit) {
            ...
            if (service == null) {
                complete(error("SERVICE_UNAVAILABLE", "Enable Cuplivo phone control in Android Accessibility settings. If already enabled, turn the service off and on again.").toString())
                return
            }

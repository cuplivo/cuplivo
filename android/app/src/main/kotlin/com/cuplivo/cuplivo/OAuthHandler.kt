...
internal object OAuthHandler {
    ...
    private const val CALLBACK_SCHEME = "com.cuplivo.cuplivo"
        ...
        MethodChannel(messenger, CHANNEL_NAME).setMethodCallHandler { call, result ->
            when (call.method) {
                "authenticate" -> {
                    ...
                    if (current == null) result.error("foreground_required", "Open Cuplivo to authorize this connection.", null)
    ...
    private fun authenticate(
        ...
        if (
            ...
            result.error(
                "invalid_arguments",
                "A valid HTTPS authorization URL, state, and Cuplivo callback URI are required.",
                null,
            )
            return
        }
